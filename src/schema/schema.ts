...
import impact from './schemas/Impact.schema.json';
import industry from './schemas/Industry.schema.json';
import insight from './schemas/Insight.schema.json';
import macroTrend from './schemas/MacroTrend.schema.json';
import marketForce from './schemas/MarketForce.schema.json';
